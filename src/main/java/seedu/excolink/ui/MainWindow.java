...
public class MainWindow extends UiPart<Stage> {
    ...
    void fillInnerParts() {
        ...
        StatusBarFooter statusBarFooter = new StatusBarFooter(logic.getExcoLinkFilePath());
     ...
     *
     * @see seedu.excolink.logic.Logic#execute(String)
     */
    ...
    private void showSubcomList() {
        if (subcomListPanel == null) {
            subcomListPanel = new SubcomListPanel(logic.getSubcomList(), logic.getFilteredPersonList());
        }
