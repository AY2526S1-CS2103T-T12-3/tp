...
public class ParserUtilTest {
    ...
    @Test
    public void parseSubcom_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtil.parseSubcom(null));
    }

    @Test
    public void parseSubcom_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseSubcom(INVALID_SUBCOM));
    }

    @Test
    public void parseSubcom_validValueWithoutWhitespace_returnsSubcom() throws Exception {
        Subcom expectedSubcom = new Subcom(VALID_SUBCOM);
        assertEquals(expectedSubcom, ParserUtil.parseSubcom(VALID_SUBCOM));
    }

    @Test
    public void parseSubcom_validValueWithWhitespace_returnsTrimmedSubcom() throws Exception {
        String subcomWithWhitespace = WHITESPACE + VALID_SUBCOM + WHITESPACE;
        Subcom expectedSubcom = new Subcom(VALID_SUBCOM);
        assertEquals(expectedSubcom, ParserUtil.parseSubcom(subcomWithWhitespace));
    }
}
